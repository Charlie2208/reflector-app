...
<footer>
    ...
    <div className="footer-bottom">
      ...
      <div className="social-links">
             {/* <!-- Instagram --> */}
        <a href="https://www.instagram.com/reflectoram" className="social-link" aria-label="Instagram">
        ...
        <a href="https://facebook.com/reflectoram" className="social-link" aria-label="Facebook">
